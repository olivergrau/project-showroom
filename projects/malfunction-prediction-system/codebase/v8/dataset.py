...
class CMAPSSDataset(Dataset):
    def __init__(self, data_dir, data_index, feature_cols, mode="train", 
                 ...
                 standard_scale=True, filter_fn=None, random_state=42):
        """
        ...
        Args:
            ...
            filter_fn (callable, optional): A function that filters engines from the loaded data.
                                             Should accept a DataFrame and return a filtered DataFrame.
        ...
        if self.filter_fn:
            self.data = self.filter_fn(self.data)
            print(f"Applied filter function. New dataset size: {len(self.data)} samples.")
    ...
    def _scale_features(self):
        ...
        if self.mode == "train":
            ...
            if self.scaler is None:
                print("Creating StandardScaler for training...")
