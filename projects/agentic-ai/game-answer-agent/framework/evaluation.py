...
from framework.react_agent import AgentState
from framework.state_machine import Run
from framework.llm import LLM
from framework.messages import AIMessage, BaseMessage
...
class EvaluationReport(BaseModel):
    """Report for document retrieval evaluation"""
...
class AgentEvaluator:
    ...
    def __init__(self, api_key: Optional[str] = None, base_url: Optional[str] = None):
        self.llm_judge = LLM(model="gpt-4o-mini", api_key=api_key, base_url=base_url)
