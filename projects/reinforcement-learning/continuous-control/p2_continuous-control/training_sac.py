...
log_dir = os.path.join("runs", "run_sac_" + datetime.now().strftime("%Y-%m-%d_%H-%M-%S"))
...
# Our worker imports
from codebase.sac.env import env_worker
from codebase.sac.train import train_worker
from codebase.sac.eval import eval_worker
...
if __name__ == '__main__':
    ...
    lr_actor = 1e-3
    lr_critic = 5e-4
    lr_alpha = 1e-3  # Learning rate for temperature parameter
    upd_w_frequency = 1 # weight update after batches / iterations
